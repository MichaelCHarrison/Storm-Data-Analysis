...
Adjusting property and crop damage values for inflation
...
stormdt <- 
        stormdt %>%
        mutate(adjyear = year(stormdt$bgn_datetime),
               adjustment = yearly_cpi$adjustment[match(stormdt$adjyear,
                                                   yearly_cpi$cpi_year)])
               
yearly_cpi$adjustment[match(stormdt$adjyear, yearly_cpi$cpi_year)]
