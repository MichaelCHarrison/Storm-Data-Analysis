...
```{r results = "asis"}
knitr::kable(head(event_fatalities, n=10), caption = "Total Fatalities by Event",
             col.names = c("Event", "Total Fatalities",
                           "Fatalities per Year", "Occurences",
                           "Fatatlies per Occurence"))
```
...
flood_propdmg %>% 
_avg <-
        flood_propdmg        summarise(monthlydmgavg = mean(propdmg)) %>%
        print()
```
